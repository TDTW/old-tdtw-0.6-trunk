...
MACRO_CONFIG_INT(ClHudShowAmmo, cl_hud_show_ammo, 1, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Show ammo")
MACRO_CONFIG_INT(ClHudShowWeapon, cl_hud_show_weapon, 1, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Show weapon")

MACRO_CONFIG_INT(ClChatShowtime, cl_chat_showtime, 15, 5, 60, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Time to show message")
MACRO_CONFIG_INT(ClChatHeightlimit, cl_chat_heightlimit, 80, 50, 184, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Chat height limit")
MACRO_CONFIG_INT(ClChatEffects, cl_chat_effects, 1, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Show chat effects")
MACRO_CONFIG_INT(ClChatBackground, cl_chat_background, 40, 0, 100, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Show chat background")
MACRO_CONFIG_INT(ClChatSpeed, cl_chat_speed, 5, 4, 10, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Speed of chat")

MACRO_CONFIG_INT(ClEffectsFlagtrail, cl_effects_flagtrail, 1, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "FlagTrail")
MACRO_CONFIG_INT(ClEffectsWeapontrail, cl_effects_weapontrail, 1, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "WeaponTrail")
...
MACRO_CONFIG_INT(HudModHideHealthAndAmmo, hudmod_hide_health_and_ammo, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide health and ammo")
MACRO_CONFIG_INT(HudModHideGameTimer, hudmod_hide_game_timer, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide game timer")
MACRO_CONFIG_INT(HudModHideSuddenDeath, hudmod_hide_sudden_death, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide sudden death")
MACRO_CONFIG_INT(HudModHideScoreHud, hudmod_hide_score_hud, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide score hud")
MACRO_CONFIG_INT(HudModHideWarmupTimer, hudmod_hide_warmup_timer, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide warmup timer")
MACRO_CONFIG_INT(HudModHideTeambalanceWarning, hudmod_hide_teambalance_warning, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide teambalance warning")
MACRO_CONFIG_INT(HudModHideVoting, hudmod_hide_voting, 0, 0, 1, CFGFLAG_SAVETDTW|CFGFLAG_CLIENT, "Hide voting")
